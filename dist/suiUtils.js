...
exports.listPackageEvents = listPackageEvents;
exports.getEventsForType = getEventsForType;
 ...
 */
async function listPackageEvents(suiClient, packageId) {
 ...
 */
async function getEventsForType(suiClient, eventType, sinceTimestampMs) {
 ...
 */
async function subscribeToEvent(suiClient, packageId, eventType, onEvent) {
